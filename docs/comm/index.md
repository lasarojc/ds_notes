...
As camadas de abstração mais básicas do desenvolvimento de sistemas distribuídos estão nas **redes de computadores**, que afinal servem de substrato a todo e qualquer sistema distribuído.
