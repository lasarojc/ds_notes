...
Há muitos recursos *online*  para se aprender mais sobre como usar o Cassandra, por exemplo, [aqui](http://wiki.apache.org/cassandra/GettingStarted).
Há também diversos projetos de código livre que o usam e podem ser estudados, por exemplo, o clone do Twitter [Twissandra](https://github.com/twissandra/twissandra).
